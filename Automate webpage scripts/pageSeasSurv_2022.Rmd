...
#### **Telemetry Study Template** for this study can be found [here](https://drive.google.com/file/d/1ilRE5-Rl8vhxTOxIcmT_G94tAAGjNZML/view?usp=sharing)
...
if (nrow(detects_study) == 0){
   ...
   detects_study[detects_study$release_time > as.POSIXct("1/31/2022 12:00:00"), "Release"] <- "Week 2"
   detects_study[detects_study$release_time > as.POSIXct("2/7/2022 12:00:00"), "Release"] <- "Week 3"
   detects_study[detects_study$release_time > as.POSIXct("3/15/2022 12:00:00"), "Release"] <- "Week 4"
   detects_study[detects_study$release_time > as.POSIXct("3/19/2022 12:00:00"), "Release"] <- "Week 5"
   detects_study[detects_study$release_time > as.POSIXct("4/23/2022 12:00:00"), "Release"] <- "Week 6"
   detects_study[detects_study$release_time > as.POSIXct("5/1/2022 12:00:00"), "Release"] <- "Week 7"
